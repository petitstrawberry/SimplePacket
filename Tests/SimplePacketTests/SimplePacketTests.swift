...
@Test func decode() async throws {
    let data = Data([0x01, 0x03, 0x00, 0x01, 0x02, 0x03, 0x02, 0x02, 0x00, 0x01, 0x02, 0x00, 0x00])
...
@Test func encode() async throws {
    ...
    #expect(data == Data([0x01, 0x03, 0x00, 0x01, 0x02, 0x03, 0x02, 0x02, 0x00, 0x01, 0x02, 0x00, 0x00]))
}
